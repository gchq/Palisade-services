...
*/}}
{{- define "query-scope-service.name" -}}
...
*/}}
{{- define "query-scope-service.fullname" -}}
...
*/}}
{{- define "query-scope-service.chart" -}}
...
Common labels
*/}}
{{- define "query-scope-service.labels" -}}
app.kubernetes.io/name: {{ include "query-scope-service.name" . }}
helm.sh/chart: {{ include "query-scope-service.chart" . }}
...
*/}}
{{- define "query-scope-service.root" -}}
...
*/}}
{{- define "query-scope-service.deployment.path" }}
...
*/}}
{{- define "query-scope-service.deployment.name" }}
{{- include "query-scope-service.deployment.path" . | base }}
{{- end }}

{{/*
Calculate a storage full name based on the code release artifact id or the supplied value of codeRelease
*/}}
{{- define "query-scope-service.deployment.fullname" }}
{{- .Values.global.persistence.classpathJars.name }}-{{- include "query-scope-service.deployment.name" . }}
{{- end }}
