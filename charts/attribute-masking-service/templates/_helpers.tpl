...
*/}}
{{- define "attribute-masking-service.name" -}}
...
*/}}
{{- define "attribute-masking-service.fullname" -}}
...
*/}}
{{- define "attribute-masking-service.chart" -}}
...
Common labels
*/}}
{{- define "attribute-masking-service.labels" -}}
app.kubernetes.io/name: {{ include "attribute-masking-service.name" . }}
helm.sh/chart: {{ include "attribute-masking-service.chart" . }}
...
*/}}
{{- define "attribute-masking-service.root" -}}
...
{{- printf "%s-%s-%s" .Values.global.persistence.classpathJars.name (include "attribute-masking-service.deployment.revision" .) (include "palisade.namespace" .) | replace "/" "-"}}
{{- end }}
