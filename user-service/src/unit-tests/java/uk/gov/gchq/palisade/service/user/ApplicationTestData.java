...
public class ApplicationTestData {
    ...
    public static final UserRequest REQUEST = UserRequest.Builder.create()
            .withUserId(USER_ID.getId())
            .withResourceId(RESOURCE_ID)
            .withContext(CONTEXT);

    public static final UserResponse RESPONSE = UserResponse.Builder.create(REQUEST)
            .withUser(USER);

    public static final ProducerRecord<String, UserRequest> START = new ProducerRecord<>("rule", 0, null, null);

    public static final ProducerRecord<String, UserRequest> RECORD = new ProducerRecord<>("rule", 0, null, REQUEST);

    public static final ProducerRecord<String, UserRequest> END = new ProducerRecord<>("rule", 0, null, null);
    ...
    public static final Supplier<Stream<ProducerRecord<String, UserRequest>>> RECORD_FACTORY = () -> Stream.iterate(0, i -> i + 1)
            .map(i -> UserRequest.Builder.create()
                    .withUserId(USER_ID.getId())
                    .withResourceId(RESOURCE_ID)
                    .withContext(CONTEXT))
