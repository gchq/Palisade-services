...
public class AuditableException extends RuntimeException {
    private final transient ConsumerRecord<String, UserRequest> request;
     ...
     */
    public AuditableException(final ConsumerRecord<String, UserRequest> request, final Exception cause) {
        super(cause);
        this.request = request;
    }

    @Generated
    public ConsumerRecord<String, UserRequest> getRequest() {
        return request;
    }
}