...
import uk.gov.gchq.palisade.service.topicoffset.service.AuditService;
...
public class TopicOffsetController {
    ...
    public TopicOffsetController(final TopicOffsetService topicOffsetService, final AuditService auditService) {
