...
public final class AuditErrorMessage extends AuditMessage {
    ...
    public static class Builder {
        ...
        /**
         * Starter method for the Builder class that uses a TopicOffsetRequest for the request specific part of the Audit message.
         ...
         */
        public static IError create(final TopicOffsetRequest request, final Map<String, Object> attributes) {
            return create()
