 ...
 */
package uk.gov.gchq.palisade.servcie.topicoffset.kafka;
...
class KafkaContractTest {
    ...
    static void startTestcontainers() {
        ...
        producerProperties = Map.of(
                ...
                ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, uk.gov.gchq.palisade.serivce.topicoffsetservice.kafka.KafkaContractTest.TopicOffsetRequestSerialiser.class);
        consumerProperties = Map.of(
                ...
                ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, uk.gov.gchq.palisade.serivce.topicoffsetservice.kafka.KafkaContractTest.TopicOffsetResponseDeserialiser.class);
    }
    ...
    void sendAndReceiveTest() throws ExecutionException, InterruptedException {
        ...
        LinkedList<ConsumerRecord<String, uk.gov.gchq.palisade.serivce.topicoffsetservice.kafka.KafkaContractTest.TopicOffsetResponseDeserialiser>> resultsList;
