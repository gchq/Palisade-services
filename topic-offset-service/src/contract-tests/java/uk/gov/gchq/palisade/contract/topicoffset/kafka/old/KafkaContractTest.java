...
import static uk.gov.gchq.palisade.contract.topicoffset.kafka.old.ContractTestConfiguration.consumeWithTimeout;
...
class KafkaContractTest {
    ...
    void sendAndReceiveTest() throws ExecutionException, InterruptedException {
        ...
        try (KafkaConsumer<String, TopicOffsetResponse> consumer = new KafkaConsumer<>(consumerProperties)) {
            consumer.subscribe(Collections.singletonList("masked-resource"));
