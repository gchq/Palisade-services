...
public class KafkaProducerService {
     ...
     */
    public CompletableFuture<Void> resourceRequestMulti(final Map<String, String> headers,
        ...
        return Source
                ...
                .map(request -> new ProducerRecord<String, ResourceRequest>(topic.getName(), partition, null, request.orElse(null), kafkaHeaders))
