...
public interface ErrorHandlingService {
     ...
     *
     * @param resourceRequest   original request input to the service
     ...
     */
    default AuditErrorMessage createErrorMessage(final ResourceRequest resourceRequest, final Map<String, Object> attributes, final Throwable error) {
        return AuditErrorMessage.Builder.create(resourceRequest, attributes)
                .withError(error);
    }
}
