...
/**
 * This class is used to encapsulate the list of {@link Rule}s that apply to a resource and is provided with a user-friendly message to explain what the set of rules are.
 *
