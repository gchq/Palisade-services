 ...
 * of the prototype classes ReultsRequest and ResultsResponse and the related tests.
 */
...
public class ResultsApplication {
    ...
    public static void main(final String[] args) {
        new SpringApplicationBuilder(ResultsApplication.class).web(WebApplicationType.SERVLET)
                .run(args);
    }
}
