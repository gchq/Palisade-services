...
class RulesConverterTest {
    ...
    void rulesConverterIsConsistent() {
        ...
        // when
        String databaseColumn = rulesConverter.convertToDatabaseColumn(QueryScopeApplicationTestData.RULES);
        // then
        assertThat(rulesConverter.convertToDatabaseColumn(QueryScopeApplicationTestData.RULES)).isEqualTo(databaseColumn);
    ...
    void rulesConverterIsCorrect() {
        ...
        Rules<?> convertedRules = rulesConverter.convertToEntityAttribute(databaseColumn);
        // then
        assertThat(convertedRules).isEqualTo(QueryScopeApplicationTestData.RULES);
        LOGGER.info("{} -> {}", QueryScopeApplicationTestData.RULES, databaseColumn);
    }
