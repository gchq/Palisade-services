...
class UserConverterTest {
    ...
    void userConverterIsConsistent() {
        ...
        // when
        String databaseColumn = userConverter.convertToDatabaseColumn(QueryScopeApplicationTestData.USER);
        // then
        assertThat(userConverter.convertToDatabaseColumn(QueryScopeApplicationTestData.USER)).isEqualTo(databaseColumn);
    ...
    void userConverterIsCorrect() {
        ...
        User convertedUser = userConverter.convertToEntityAttribute(databaseColumn);
        // then
        assertThat(convertedUser).isEqualTo(QueryScopeApplicationTestData.USER);
        LOGGER.info("{} -> {}", QueryScopeApplicationTestData.USER, databaseColumn);
    }
