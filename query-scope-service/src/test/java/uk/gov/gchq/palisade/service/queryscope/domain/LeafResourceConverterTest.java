...
class LeafResourceConverterTest {
    ...
    void leafResourceConverterIsConsistent() {
        ...
        // when
        String databaseColumn = leafResourceConverter.convertToDatabaseColumn(QueryScopeApplicationTestData.LEAF_RESOURCE);
        // then
        assertThat(leafResourceConverter.convertToDatabaseColumn(QueryScopeApplicationTestData.LEAF_RESOURCE)).isEqualTo(databaseColumn);
    ...
    void leafResourceConverterIsCorrect() {
        ...
        LeafResource convertedLeafResource = leafResourceConverter.convertToEntityAttribute(databaseColumn);
        // then
        assertThat(convertedLeafResource).isEqualTo(QueryScopeApplicationTestData.LEAF_RESOURCE);
        LOGGER.info("{} -> {}", QueryScopeApplicationTestData.LEAF_RESOURCE, databaseColumn);
    }
