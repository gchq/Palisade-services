...
public class AuditErrorMessageTest {
    ...
    public void testSerialiseAuditErrorMessageToJson() throws IOException {
        ...
        assertThat(auditErrorMessageJsonContent).extractingJsonPathStringValue("$.serviceName").isEqualTo("query-scope-service");
    ...
    public void testDeserialiseJsonToAuditErrorMessage() throws IOException {
        String jsonString = "{\"userId\":\"originalUserID\",\"resourceId\":\"testResourceId\",\"context\":{\"class\":\"uk.gov.gchq.palisade.Context\",\"contents\":" +
                ...
                "\":\"Something went wrong!\"},\"serveHostName\":\"host.name\",\"serviceName\":\"query-scope-service\",\"timestamp\":\"2020-01-01T08:00:00.000000Z\",\"serverIP" +
        ...
        assertThat(auditErrorMessage.getServiceName()).isEqualTo("query-scope-service");
