...
class SimpleQueryScopeServiceTest {
    ...
    void queryScopeServiceDelegatesToPersistenceLayer() {
        // given
        QueryScopeService queryScopeService = new SimpleQueryScopeService(mockPersistenceLayer);

        // when
        queryScopeService.storeRequestResult(
