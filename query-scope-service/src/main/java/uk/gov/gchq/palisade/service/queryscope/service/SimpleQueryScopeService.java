...
package uk.gov.gchq.palisade.service.queryscope.service;
...
public class SimpleQueryScopeService implements QueryScopeService {
    private static final Logger LOGGER = LoggerFactory.getLogger(SimpleQueryScopeService.class);

    private final JpaPersistenceLayer persistenceLayer;

    public SimpleQueryScopeService(final JpaPersistenceLayer persistenceLayer) {
