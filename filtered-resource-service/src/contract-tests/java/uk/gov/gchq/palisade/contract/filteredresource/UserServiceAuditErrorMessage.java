...
public final class UserServiceAuditErrorMessage extends UserServiceAuditMessage {
    ...
    @JsonCreator
    private UserServiceAuditErrorMessage(
    ...
    public static class Builder {
        ...
        public static IUserId create() {
            return userId -> resourceId -> context -> attributes -> error ->
                    new UserServiceAuditErrorMessage(userId, resourceId, context, attributes, error);
        }
        ...
        public interface IError {
             ...
             * @return class  {@link UserServiceAuditErrorMessage} for the completed class from the builder.
             */
            UserServiceAuditErrorMessage withError(Throwable error);
        }
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UserServiceAuditErrorMessage)) {
            return false;
        }
        if (!super.equals(o)) {
            return false;
        }
        UserServiceAuditErrorMessage that = (UserServiceAuditErrorMessage) o;
    ...
    public String toString() {
        return new StringJoiner(", ", UserServiceAuditErrorMessage.class.getSimpleName() + "[", "]")
                .add("error=" + error)
                .add(super.toString())
                .toString();
    }
