...
@RedisHash("TopicOffsetEntity")
public class TopicOffsetEntity implements Serializable {
    ...
    public TopicOffsetEntity(final String token, final Long offset) {
        this.token = token;
        this.offset = offset;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof TopicOffsetEntity)) {
            return false;
        }
        final TopicOffsetEntity that = (TopicOffsetEntity) o;
