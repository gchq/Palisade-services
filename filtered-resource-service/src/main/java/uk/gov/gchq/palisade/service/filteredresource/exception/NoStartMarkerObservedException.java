 ...
 * Filtered Resource implementation to
 * indicate that the Start of stream doesn't exist or wasn't observed.
 */
public class NoStartMarkerObservedException extends RuntimeException {
    private static final Logger LOGGER = LoggerFactory.getLogger(NoStartMarkerObservedException.class);
    ...
    public NoStartMarkerObservedException(final String message) {
        super(message);
        LOGGER.info("NoStartMarkerObservedException thrown with '{}'", message);
    }
    ...
    public NoStartMarkerObservedException(final String message, final Throwable throwable) {
        ...
        LOGGER.error("NoStartMarkerObservedException thrown with '{}'", message);
    }
}
