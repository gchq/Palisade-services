...
public interface TopicOffsetRepository extends CrudRepository<TopicOffsetEntity, String> {

    default void save(final String token, final Long offset) {
        save(new TopicOffsetEntity(token, offset));
    }

    Optional<TopicOffsetEntity> findByToken(final String token);
