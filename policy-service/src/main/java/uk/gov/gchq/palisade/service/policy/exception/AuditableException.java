...
public class AuditableException extends RuntimeException {
    private final transient ConsumerRecord<String, PolicyRequest> request;
     ...
     */
    public AuditableException(final ConsumerRecord<String, PolicyRequest> request, final Exception cause) {
        super(cause);
        this.request = request;
    }

    @Generated
    public ConsumerRecord<String, PolicyRequest> getRequest() {
        return request;
    }
}
