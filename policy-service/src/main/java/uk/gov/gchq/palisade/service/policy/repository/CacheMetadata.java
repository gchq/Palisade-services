...
public class CacheMetadata {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(wasRetrievedLocally, canRetrieveLocally);
    }

    @Override
    public String toString() {
        return new StringJoiner(", ", CacheMetadata.class.getSimpleName() + "[", "]")
                .add("wasRetrievedLocally=" + wasRetrievedLocally)
                .add("canRetrieveLocally=" + canRetrieveLocally)
                .toString();
    }
}
