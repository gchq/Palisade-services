...
public interface ErrorHandlingService {
     ...
     *
     * @param policyRequest original request input to the service
     ...
     */
    default AuditErrorMessage createErrorMessage(final PolicyRequest policyRequest, final Map<String, Object> attributes, final Throwable error) {
        return AuditErrorMessage.Builder.create(policyRequest, attributes)
                .withError(error);
    }
