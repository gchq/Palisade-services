...
public final class CacheCodecRegistry {
     ...
     * JSON decoder.
     */
    public static final BiFunction<byte[], ? extends Class<?>, ?> DEFAULT_DECODER = JSONSerialiser::deserialise;
    ...
    /**
     * Find an appropriate encoder for a given class. Returns {@link #DEFAULT_ENCODER} if no specific
    ...
    /**
     * Find an appropriate decoder for a given class. Returns {@link #DEFAULT_DECODER} if no specific
