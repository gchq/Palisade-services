...
public interface ErrorHandlingService {
     ...
     *
     * @param palisadeRequest original request input to the service
     ...
     */
    default AuditErrorMessage createErrorMessage(final PalisadeRequest palisadeRequest, final Map<String, Object> attributes, final Throwable error) {
        return AuditErrorMessage.Builder.create(palisadeRequest, attributes)
                .withError(error);
    }
