...
public class AuditErrorMessageTest {
     ...
     */
    @Test
    public void teastGroupedDependantErrorMessageSerialisingAndDeserialising() throws IOException {
        ...
        assertAll("AuditSerialisingDeseralisingAndComparison",
                ...
                () -> assertAll("AuditDeserialisingComparedToObject",
                        ...
                        () -> assertThat(auditErrorMessageObject.getAttributes()).isEqualTo(auditErrorMessage.getAttributes()),
