...
* jackson-databind ([com.fasterxml.jackson.core:jackson-databind:2.9.10.4](http://github.com/FasterXML/jackson))
...
* Spring Cloud Commons ([org.springframework.cloud:spring-cloud-commons:2.2.0.RELEASE](https://projects.spring.io/spring-cloud/spring-cloud-commons/))
...
* Spring Cloud Starter Netflix Eureka Server ([org.springframework.cloud:spring-cloud-starter-netflix-eureka-server:2.2.0.RELEASE](https://projects.spring.io/spring-cloud))
...
* spring-cloud-starter-ribbon ([org.springframework.cloud:spring-cloud-starter-ribbon:1.4.7.RELEASE](https://projects.spring.io/spring-cloud))
* common ([uk.gov.gchq.palisade:common:0.4.0-SNAPSHOT](no url defined))
* hadoop-reader ([uk.gov.gchq.palisade:hadoop-reader:0.4.0-SNAPSHOT](no url defined))
* hadoop-resource ([uk.gov.gchq.palisade:hadoop-resource:0.4.0-SNAPSHOT](no url defined))
