...
public class AuditErrorMessageTest {
    ...
    public void testDeserialiseJsonToAuditErrorMessage() throws IOException {
        ...
        assertThat(auditErrorMessage.getServiceName()).isEqualTo("testServicename");
        assertThat(auditErrorMessage.getServerIP()).isEqualTo("testServerIP");
        assertThat(auditErrorMessage.getServeHostName()).isEqualTo("testServerHostname");
        assertThat(auditErrorMessage.getAttributes().get("messagesSent")).isEqualTo("23");
