...
public final class ApplicationTestData {
    ...
    public static final String TEST_SERVICE_NAME = "the service name, e.g. UserService";
    public static final String TEST_TIMESTAMP = new Date().toString();
    ...
    public static final String TEST_LEAF_RESOURCE_ID = "the id of a found leaf resource";
